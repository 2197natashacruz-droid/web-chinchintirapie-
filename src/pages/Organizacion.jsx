    ...
    <>
      ...
      <main style={{ background: 'var(--crema)' }}>
        ...
        <section style={{ padding: '4rem 2rem' }}>
          ...
          <div className="cuerpos-grid">
            {CUERPOS.map(({ img, title, desc }) => {
              const cardClass =
                title === 'Cuerpo de Banda'
                  ? 'cuerpo-card cuerpo-card-banda'
                  : title === 'Cuerpo de Baile'
                  ? 'cuerpo-card cuerpo-card-baile'
                  : 'cuerpo-card cuerpo-card-figurines';

              return (
                <article key={title} className={`reveal ${cardClass}`}>
        ...
        <section style={{ background: 'var(--morado-o)', padding: '5rem 2rem' }}>
          ...
          <div className="engranajes-grid">
            {ENGRANAJES.map(({ icon, title, desc }) => (
              <article key={title} className="reveal engranaje-card">
